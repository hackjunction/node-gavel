  ...
  render() {
    ...
    return (
      <div className={error ? 'FormField has-error' : 'FormField'}>
        <label
          className={
            required ? 'FormField--label is-required' : 'FormField--label'
          }
        >
          {this.props.label}
        </label>
        <div className="FormField--content-wrapper">
          <div
            className={
              success
                ? 'FormField--input-wrapper has-success'
                : 'FormField--input-wrapper'
            }
          >
            <textarea
              className="FormField--input FormField--textarea"
              type="text"
              rows={10}
            ...
            <div className="FormField--success">
              <span className="FormField--success-msg">
                {success ? message : ''}
              </span>
